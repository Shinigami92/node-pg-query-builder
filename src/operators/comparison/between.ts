...
export class BetweenComparisonOperator extends ComparisonOperator {
	public static between(column: ColumnDefinition, x: number, y: number): BetweenComparisonOperator;
	public static between(column: ColumnDefinition, x: string, y: string): BetweenComparisonOperator;
	public static between(column: ColumnDefinition, x: any, y: any): BetweenComparisonOperator {

...
export function le(column: ColumnDefinition, value: string | number | QueryBuilder): LessEqualComparisonOperator {
	return new LessEqualComparisonOperator(column, value);
}
